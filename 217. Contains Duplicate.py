...
#Problem I faced : While solving this question i understood the problem statement as well as
#  logic for the problem but due to my lack if practice from so many days i forgot the syntax of how to check the value in dictionary like for key,value in dict.items(). 
